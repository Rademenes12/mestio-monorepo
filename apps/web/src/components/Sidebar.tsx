...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 flex w-[240px] flex-col overflow-hidden"
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 h-16 shrink-0" style={{ borderBottom: "1px solid rgba(255,255,255,.08)" }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "8px", color: "#7F96B5", letterSpacing: ".6px" }}>ADMIN · CRM</div>
        </div>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-3 space-y-0.5">
          ...
          return (
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
                <path d={NAV_ICONS[item.key] || NAV_ICONS.dashboard} />
              </svg>
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors w-full mt-1"
          style={{ color: "#7F96B5" }}
          onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(255,255,255,.06)"; e.currentTarget.style.color = "#C7D2E0"; }}
          onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#7F96B5"; }}
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="shrink-0">
        ...
        <div className="mt-6 mb-2" style={{ borderTop: "1px solid rgba(255,255,255,.08)", paddingTop: "12px" }}>
          <div className="px-3 py-1.5">
            <span style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "9px", fontWeight: 600, textTransform: "uppercase", letterSpacing: ".6px", color: "#7F96B5" }}>Ostatnie</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm" style={{ color: "#7F96B5" }}>
      ...
      <div className="px-3 py-3 shrink-0" style={{ borderTop: "1px solid rgba(255,255,255,.08)" }}>
        ...
        <div className="flex items-center gap-2.5 mt-2 pt-2" style={{ borderTop: "1px solid rgba(255,255,255,.06)" }}>
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[12px] font-semibold truncate" style={{ color: "#D5DEEC" }}>AIVOLUX</div>
            <div style={{ fontSize: "10px", color: "#7F96B5" }}>Właściciel platformy</div>
          </div>
        </div>
      </div>
    </aside>
