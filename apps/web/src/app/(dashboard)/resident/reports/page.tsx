  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-heading font-bold text-ink">Moje zgłoszenia</h1>
      ...
      {rlist.length === 0 ? (
        <div className="bg-white rounded-[16px] shadow-[0_2px_12px_rgba(14,26,43,.06)] p-12 text-center border border-[#EAF0F7]">
          <p className="text-ink/60 text-base font-medium">Nie masz jeszcze żadnych zgłoszeń.</p>
          <p className="text-ink/40 text-sm mt-2">
            Zgłoś sprawę przez aplikację mobilną Mestio — pojawi się tutaj automatycznie.
          </p>
        </div>
      ) : (
