-- =====================================================
-- Fix: Use correct column name 'attempted_at' in fixflow_redeem_invitation_code
-- =====================================================
-- Migration 0028 introduced a typo: it queried 'created_at' instead of
-- 'attempted_at' in fixflow_code_redemption_attempts, causing a 42703 error
-- on every redemption attempt. This migration replaces the function with the
-- correct column name.
...
COMMENT ON FUNCTION fixflow_redeem_invitation_code IS 
  'FIXED (0036): corrected column name from created_at to attempted_at in rate-limit query';
